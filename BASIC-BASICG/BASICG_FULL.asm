...
REASON	CALL	REASON1		;ENOUGH SPACE BETWEEN STRING & STACK
	...
	RET	NC		;YES
	JR	OMERR		;NO, GIVE "OUT OF MEMORY BUT DONT TOUCH STACK
...
;	TODO: rename SINLIN to PINLIN (GW-BASIC and MBASIC)
	CALL	SINLIN		;GET PROGRAM LINE INPUT
	POP	DE
	JR	NC,NTSTOP?	;TODO label: NTSTOP in GW-BASIC
	XOR	A
...
NTAUTO	CALL	SINLIN		;GET PROGRAM LINE INPUT
	JR	C,MAIN
	PUSH	AF		;--->
	PUSH	BC
	PUSH	DE
...
;
;	TODO: DEF --> DEFST
DEF	CP	USRTK		;DEFINING THE CALL ADDRESS OF USR ROUTINE?
...
INIT17	OR	A		;TODO: label vs. MBASIC
	LD	A,H
	RRA
	LD	H,A
	LD	A,L
	...
	JR	C,INIT18
	LD	HL,0200H
INIT18	LD	A,E		;SUBTRACT STACK SIZE FROM TOP MEM ;TODO: label vs. MBASIC
	SUB	L
	LD	L,A
	LD	A,D
	SBC	A,H
