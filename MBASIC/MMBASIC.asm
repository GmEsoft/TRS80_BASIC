...
FOUTFX1	LD	A,E		;GET THE FIELD LENGTHS BACK
...
FFXXV31	CALL	FOUTCV		;CONVERT THE NUMBER TO DECIMAL DIGITS
...
;	we can print
	...
	CALL	FOSEDP		;IN CASE D.P. IS LAST ON LIST
...
FOTZER1	RET	Z		;RETURN IF WE ARE DONE
	...
	JP	FOTZER1		;GO SEE IF WE ARE NOW DONE
...
FOTTZR	JP	NZ,FOTTZR2	;ENTRY AFTER A "CALL FOUTCV"
...
FOTTZR2	LD	(HL),'0'	;PUT A ZERO IN THE BUFFER
	...
	JP	FOTTZR1		;GO BACK AND SEE IF WE ARE DONE
...
FOUNSCB	JP	NZ,FOUSEP	;IF NOT D.P. TIME, SEE IF COMMA TIME
...
FDPDVS	INC	B		;INCREMENT THE DIGIT COUNT
	...
	JP	NC,FDPDVS	;IF THE NUMBER WAS NOT LESS THAN THE POWER OF TEN,
				; SUBTRACT AGAIN
	...
	JP	NZ,FDPL10	;NO, GO DO THE NEXT ONE
...
FSPDVS	INC	B		;ADD ONE TO DIGIT
	...
	DEC	HL
	JP	NC,FSPDVS	;SUBTRACT AGAIN IF RESULT WAS POSITIVE
	...
	JP	C,FOUCSP2	;CALCULATE NEXT DIGIT IF WE HAVE NOT DONE 2
