...
;
SIGNON$	DB	'Add enhancement package to BASICG',LF
	DB	'Copyright (C) 1984 by Logical Systems, Inc.',LF,CR
BASPMT	DB	'Enter drive containing BASICG/CMD to be modified ',3
;
NOBAS$	DB	'Can''t open BASICG/CMD on that drive',LF,CR
BUERR$	DB	'Can''t find BASICG enhancement file',CR
LMFERR$	DB	'BASICG/CMD: Load module format error',CR
N62ERR$	DB	'Enhancements require BASICG version 01.01.00',CR
